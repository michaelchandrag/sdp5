			...
			<div class='x_panel'>
				...
				<div class="x_content">
					<?php
						...
						$ambilpromo = $this->mdpenjualan->cekpromo();
						foreach($ambilpromo as $row)
						{}
						$diskonan = (intval($this->cart->total())*intval($row->DISKON))/intval(100);
						$hasildiskon = intval($this->cart->total())-intval($diskonan);
						echo "<h2>Total Setelah Diskon : Rp ".number_format($hasildiskon,0,",",".")."</h2>";
